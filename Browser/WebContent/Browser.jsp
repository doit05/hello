...
<%!
	...
	*/
    ...
    private static final String BASE_PATH="/root/gc/docs";
	private static final String RESTRICT_PATH = BASE_PATH;
...
//                 }
				request.setAttribute("dir",BASE_PATH);
			}%>
...
<META HTTP-EQUIV="Refresh" CONTENT="<%=UPLOAD_MONITOR_REFRESH%>;URL=<%=browser_name %>?uplMonitor=<%=fname%>">
</head>
<body>
<b>Upload of <%=fname%></b><br><br>
<center>
